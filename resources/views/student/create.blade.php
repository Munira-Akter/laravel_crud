                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="student-img-loader"> Photo <i class ="fas fa-camera"></i> </label>
                                        <br>
                                        <input class="form-control-file" type="file" name="photo" id="student-img-loader" style="display:none;"  value="{{old('photo')}}">
                                        <img src="" id="student_img_show"><br><br>
                                        <a href="#" class="btn btn-sm btn-outline-primary" id="student_remove" style="display:none;">Remove Photo</a>
                                    </div>
                                    <div class="form-group">
                                        <input class="btn btn-dark" type="submit" value="Add Student">
                                    </div>
                                </form>
                            </div>
                        </div>
