                    ...
                    <div class="shadow">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="errors" style = 'color:green; font-size : 14px; font-weight:bold; '>{{ Session::get('success')}}</p>
                                @endif
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="teacher-img-loader"> Photo <i class ="fas fa-camera"></i> </label>
                                        <br>
                                        <input class="form-control-file" type="file" name="photo" id="teacher-img-loader" style="display:none;"  value="{{old('photo')}}">
                                        <img src="" id="teacher_img_show"><br><br>
                                        <a href="#" class="btn btn-sm btn-outline-primary" id="teacher_remove" style="display:none;">Remove Photo</a>
                                    </div>
                                    <div class="form-group">
                                        <input class="btn btn-dark" type="submit" value="Add Teacher">
                                    </div>
                                </form>
                            </div>
                        </div>
